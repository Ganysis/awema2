...
exports.HeroRendererV3 = void 0;
const hero_1 = require("../schemas/blocks/hero");
class HeroRendererV3 {
    constructor() {
        this.type = 'hero-ultra-modern';
        this.version = '3.0.0';
    }
    validate(data) {
        return hero_1.heroDataSchema.safeParse(data);
    }
    getDefaultData() {
        return hero_1.heroDefaults;
    }
    getDefaultCSS() {
        return `
/* Hero Base Styles */
...
<div class="hero-preview">
  ...
  <p>${data.subtitle || 'Hero Block'}</p>
    ...
    generateHTML(data) {
        const { variant, layout, height, eyebrow, title, subtitle, description, primaryButton, secondaryButton, image, stats, badges } = data;
        const classes = [
            'hero',
            `hero--${variant}`,
            `hero--${layout}`,
...
exports.HeroRendererV3 = HeroRendererV3;
