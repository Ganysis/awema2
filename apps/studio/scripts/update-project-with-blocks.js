...
async function updateProjectWithBlocks() {
  try {
    console.log('🔄 Mise à jour du projet avec tous les blocs...\n');

    // Les données complètes du projet avec tous les blocs
    const projectData = {
      businessInfo: {
    ...
    console.log('   Nom:', updatedProject.name);
    console.log('   Pages:', projectData.pages.length);
    ...
    console.log('\n🔗 Voir dans l\'éditeur:');
    console.log('   http://localhost:3000/editor/cmd0oiooj0001j18530sfuhwd');
    
    console.log('\n🌐 Site déployé:');
    console.log('   https://plomberie-real-1752351088455.netlify.app');
