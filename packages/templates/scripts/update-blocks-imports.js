...
function generateImports(blocks) {
...
function generateRegisterBlocks(blocks) {
  const lines = [];
  let currentCategory = '';
...
function generateExports(blocks) {
...
function updateTemplateComposer(blocks) {
