...
export function renderContentUltraModern(props: Record<string, any>, _variants: string[] = []): RenderedBlock {
  ...
  function renderComparison() {
    ...
    return `
      <div class="content-comparison">
        ...
        <div class="content-wrapper comparison-wrapper ${hasImage ? `has-image image-${imagePosition}` : 'no-image'} ${imageTop ? 'image-top' : ''} ${imageBg ? 'image-bg' : ''}">
          ${imageBg && image ? `<div class="content-bg-image" style="background-image: url('${image}');"></div>` : ''}
          
          ${hasImage && !imageBg ? `
            <div class="content-image ${imageLeft ? 'order-1' : 'order-2'}">
              <img src="${image}" alt="Comparaison" loading="lazy" />
            </div>
          ` : ''}
          
          <div class="comparison-content ${hasImage && !imageBg ? (imageLeft ? 'order-2' : 'order-1') : ''}">
  ...
  function renderTimeline() {
    ...
    return `
      <div class="content-timeline">
        ...
        <div class="content-wrapper timeline-wrapper ${hasImage ? `has-image image-${imagePosition}` : 'no-image'} ${imageTop ? 'image-top' : ''} ${imageBg ? 'image-bg' : ''}">
          ${imageBg && image ? `<div class="content-bg-image" style="background-image: url('${image}');"></div>` : ''}
          
          ${hasImage && !imageBg ? `
            <div class="content-image ${imageLeft ? 'order-1' : 'order-2'}">
              <img src="${image}" alt="Timeline" loading="lazy" />
            </div>
          ` : ''}
          
          <div class="timeline-content ${hasImage && !imageBg ? (imageLeft ? 'order-2' : 'order-1') : ''}">
  ...
  function renderStats() {
    ...
    return `
      <div class="content-stats">
        ...
        <div class="content-wrapper stats-wrapper ${hasImage ? `has-image image-${imagePosition}` : 'no-image'} ${imageTop ? 'image-top' : ''} ${imageBg ? 'image-bg' : ''}">
          ${imageBg && image ? `<div class="content-bg-image" style="background-image: url('${image}');"></div>` : ''}
          
          ${hasImage && !imageBg ? `
            <div class="content-image ${imageLeft ? 'order-1' : 'order-2'}">
              <img src="${image}" alt="Statistiques" loading="lazy" />
            </div>
          ` : ''}
          
          <div class="stats-content ${hasImage && !imageBg ? (imageLeft ? 'order-2' : 'order-1') : ''}">
  ...
  function renderTabs() {
    ...
    return `
      <div class="content-tabs">
        ...
        <div class="content-wrapper tabs-wrapper ${hasImage ? `has-image image-${imagePosition}` : 'no-image'} ${imageTop ? 'image-top' : ''} ${imageBg ? 'image-bg' : ''}">
          ${imageBg && image ? `<div class="content-bg-image" style="background-image: url('${image}');"></div>` : ''}
          
          ${hasImage && !imageBg ? `
            <div class="content-image ${imageLeft ? 'order-1' : 'order-2'}">
              <img src="${image}" alt="Tabs" loading="lazy" />
            </div>
          ` : ''}
          
          <div class="tabs-content-wrapper ${hasImage && !imageBg ? (imageLeft ? 'order-2' : 'order-1') : ''}">
  ...
  function renderAccordion() {
    ...
    return `
      <div class="content-accordion">
        ...
        <div class="content-wrapper accordion-wrapper ${hasImage ? `has-image image-${imagePosition}` : 'no-image'} ${imageTop ? 'image-top' : ''} ${imageBg ? 'image-bg' : ''}">
          ${imageBg && image ? `<div class="content-bg-image" style="background-image: url('${image}');"></div>` : ''}
          
          ${hasImage && !imageBg ? `
            <div class="content-image ${imageLeft ? 'order-1' : 'order-2'}">
              <img src="${image}" alt="FAQ" loading="lazy" />
            </div>
          ` : ''}
          
          <div class="accordion-content ${hasImage && !imageBg ? (imageLeft ? 'order-2' : 'order-1') : ''}">
            <div class="accordion-items">
              ${accordionList.map((item: any, index: number) => `
                <div class="accordion-item" data-aos="fade-up" data-aos-delay="${index * 50}">
                  ...
                  <div class="accordion-content-panel ${index === 0 ? 'active' : ''}">
  ...
  const css = `
    ...
    /* Wrapper styles for all content types with image support */
    .quote-wrapper,
    .comparison-wrapper,
    .timeline-wrapper,
    .stats-wrapper,
    ...
    .quote-wrapper.no-image,
    .comparison-wrapper.no-image,
    .timeline-wrapper.no-image,
    .stats-wrapper.no-image,
    .tabs-wrapper.no-image,
    .accordion-wrapper.no-image {
      grid-template-columns: 1fr;
      max-width: 1000px;
      margin: 0 auto;
    }
    
    .quote-wrapper.image-none,
    .comparison-wrapper.image-none,
    .timeline-wrapper.image-none,
    .stats-wrapper.image-none,
    .tabs-wrapper.image-none,
    .accordion-wrapper.image-none {
      grid-template-columns: 1fr;
    }
    
    .quote-wrapper.image-top,
    .comparison-wrapper.image-top,
    .timeline-wrapper.image-top,
    .stats-wrapper.image-top,
    .tabs-wrapper.image-top,
    .accordion-wrapper.image-top,
    .quote-wrapper.image-bottom,
    .comparison-wrapper.image-bottom,
    .timeline-wrapper.image-bottom,
    .stats-wrapper.image-bottom,
    .tabs-wrapper.image-bottom,
    .accordion-wrapper.image-bottom {
      grid-template-columns: 1fr;
    }
    ...
    .quote-wrapper.has-image .content-quote-inner {
      text-align: left;
    }
    ...
    @media (max-width: 768px) {
      ...
      .quote-wrapper.has-image .content-quote-inner,
      .comparison-wrapper.has-image .comparison-content,
      .timeline-wrapper.has-image .timeline-content,
      .stats-wrapper.has-image .stats-content,
      .tabs-wrapper.has-image .tabs-content-wrapper,
      .accordion-wrapper.has-image .accordion-content {
        text-align: center;
      }
