...
export function renderCtaSection(props) {
    const { layout = 'banner-classic', title, subtitle, primaryButtonText, primaryButtonHref, primaryButtonStyle, secondaryButtonText, secondaryButtonHref, secondaryButtonStyle, features = [], image, testimonialText, testimonialAuthor, testimonialRole, colorScheme = 'primary', size = 'medium' } = props;
    ...
    const renderButton = (button, isPrimary = true) => {
        ...
        const styleClass = styleClasses[buttonStyle] || styleClasses.filled;
        return `
    ...
    return {
        html: `
      <section class="${colors.bg} ${colors.text} ${sizeClasses[size]} cta-section cta-${layout}" data-aos="fade-up">
