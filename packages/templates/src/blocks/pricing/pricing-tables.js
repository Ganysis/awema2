...
export function renderPricingTables(props) {
    const { layout = 'cards-classic', title, subtitle, showFeatureComparison = false, colorScheme = 'primary', backgroundColor = 'gray' } = props;
    ...
    return {
        html: `
      <section class="${backgroundClasses[backgroundColor]} py-16 md:py-24 pricing-section pricing-${layout}">
