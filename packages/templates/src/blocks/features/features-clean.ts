...
export const featuresClean: Block = {
  id: 'features-clean',
  name: 'Points Forts',
...
export function renderFeaturesClean(props: Record<string, any>, variants: string[] = []): RenderedBlock {
    ...
    <section class="features-section ${hasBackground ? 'features-section--gray' : ''}">
      <div class="features-container">
        ...
        <div class="features-grid features-grid--${props.columns}">
          ${JSON.parse(props.features).map((feature: any, index: number) => `
