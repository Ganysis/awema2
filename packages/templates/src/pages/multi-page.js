import { TemplateCategory } from '@awema/shared';
...
export function generateMultiPageStructure(config) {
    var _a;
    const pages = [];
    // Home Page
    pages.push({
        ...
        blocks: [
            ...
            },
            {
                ...
                props: {
                    ...
                    services: config.services.slice(0, 3).map(s => (Object.assign(Object.assign({}, s), { link: `/services/${s.title.toLowerCase().replace(/\s+/g, '-')}` }))),
                    columns: 3,
                    showIcons: true,
                    showLinks: true
                },
            ...
            },
            {
                ...
                props: {
                    ...
                    testimonials: ((_a = config.testimonials) === null || _a === void 0 ? void 0 : _a.slice(0, 3)) || [],
                    showRating: true,
                    showImages: false,
                    autoplay: true
                },
        ...
        blocks: [
            ...
            },
            {
                ...
                props: {
                    ...
                    services: config.services.map(s => (Object.assign(Object.assign({}, s), { link: `/services/${s.title.toLowerCase().replace(/\s+/g, '-')}` }))),
                    showPricing: true,
                    showFeatures: true,
                    ctaText: 'Learn More'
                },
